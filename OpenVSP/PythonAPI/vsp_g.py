...
_vsp_g.VSP_INVALID_TYPE_swigconstant(_vsp_g)
...
_vsp_g.VSP_FILE_READ_FAILURE_swigconstant(_vsp_g)
...
_vsp_g.VSP_AMBIGUOUS_SUBSURF_swigconstant(_vsp_g)
VSP_AMBIGUOUS_SUBSURF = _vsp_g.VSP_AMBIGUOUS_SUBSURF

_vsp_g.VSP_INVALID_VARPRESET_SETNAME_swigconstant(_vsp_g)
VSP_INVALID_VARPRESET_SETNAME = _vsp_g.VSP_INVALID_VARPRESET_SETNAME

_vsp_g.VSP_INVALID_VARPRESET_GROUPNAME_swigconstant(_vsp_g)
VSP_INVALID_VARPRESET_GROUPNAME = _vsp_g.VSP_INVALID_VARPRESET_GROUPNAME

_vsp_g.VSP_CONFORMAL_PARENT_UNSUPPORTED_swigconstant(_vsp_g)
...
_vsp_g.XSEC_PROP_swigconstant(_vsp_g)
...
_vsp_g.LEN_UNITLESS_swigconstant(_vsp_g)
LEN_UNITLESS = _vsp_g.LEN_UNITLESS

_vsp_g.SET_3D_swigconstant(_vsp_g)
SET_3D = _vsp_g.SET_3D

_vsp_g.SET_2D_swigconstant(_vsp_g)
SET_2D = _vsp_g.SET_2D

_vsp_g.VIEW_LEFT_swigconstant(_vsp_g)
VIEW_LEFT = _vsp_g.VIEW_LEFT

_vsp_g.VIEW_RIGHT_swigconstant(_vsp_g)
VIEW_RIGHT = _vsp_g.VIEW_RIGHT

_vsp_g.VIEW_TOP_swigconstant(_vsp_g)
VIEW_TOP = _vsp_g.VIEW_TOP

_vsp_g.VIEW_BOTTOM_swigconstant(_vsp_g)
VIEW_BOTTOM = _vsp_g.VIEW_BOTTOM

_vsp_g.VIEW_FRONT_swigconstant(_vsp_g)
VIEW_FRONT = _vsp_g.VIEW_FRONT

_vsp_g.VIEW_REAR_swigconstant(_vsp_g)
VIEW_REAR = _vsp_g.VIEW_REAR

_vsp_g.VIEW_NONE_swigconstant(_vsp_g)
VIEW_NONE = _vsp_g.VIEW_NONE

_vsp_g.LEFT_swigconstant(_vsp_g)
LEFT = _vsp_g.LEFT

_vsp_g.RIGHT_swigconstant(_vsp_g)
RIGHT = _vsp_g.RIGHT

_vsp_g.UP_swigconstant(_vsp_g)
UP = _vsp_g.UP

_vsp_g.DOWN_swigconstant(_vsp_g)
DOWN = _vsp_g.DOWN

_vsp_g.VIEW_1_swigconstant(_vsp_g)
VIEW_1 = _vsp_g.VIEW_1

_vsp_g.VIEW_2HOR_swigconstant(_vsp_g)
VIEW_2HOR = _vsp_g.VIEW_2HOR

_vsp_g.VIEW_2VER_swigconstant(_vsp_g)
VIEW_2VER = _vsp_g.VIEW_2VER

_vsp_g.VIEW_4_swigconstant(_vsp_g)
VIEW_4 = _vsp_g.VIEW_4

_vsp_g.ROT_0_swigconstant(_vsp_g)
ROT_0 = _vsp_g.ROT_0

_vsp_g.ROT_90_swigconstant(_vsp_g)
ROT_90 = _vsp_g.ROT_90

_vsp_g.ROT_180_swigconstant(_vsp_g)
ROT_180 = _vsp_g.ROT_180

_vsp_g.ROT_270_swigconstant(_vsp_g)
ROT_270 = _vsp_g.ROT_270

_vsp_g.MANUAL_swigconstant(_vsp_g)
MANUAL = _vsp_g.MANUAL

_vsp_g.REFERENCE_swigconstant(_vsp_g)
REFERENCE = _vsp_g.REFERENCE

_vsp_g.NOSCALE_swigconstant(_vsp_g)
NOSCALE = _vsp_g.NOSCALE
...
_vsp_g.IMPORT_V2_swigconstant(_vsp_g)
IMPORT_V2 = _vsp_g.IMPORT_V2

_vsp_g.IMPORT_BEM_swigconstant(_vsp_g)
...
_vsp_g.EXPORT_BEM_swigconstant(_vsp_g)
EXPORT_BEM = _vsp_g.EXPORT_BEM

_vsp_g.EXPORT_DXF_swigconstant(_vsp_g)
EXPORT_DXF = _vsp_g.EXPORT_DXF

_vsp_g.EXPORT_FACET_swigconstant(_vsp_g)
EXPORT_FACET = _vsp_g.EXPORT_FACET

_vsp_g.EXPORT_SVG_swigconstant(_vsp_g)
...
_vsp_g.VSPAERO_PANEL_TRI_TYPE_swigconstant(_vsp_g)
...
_vsp_g.PROJ_AREA_CSV_TYPE_swigconstant(_vsp_g)
PROJ_AREA_CSV_TYPE = _vsp_g.PROJ_AREA_CSV_TYPE

_vsp_g.WAVE_DRAG_TXT_TYPE_swigconstant(_vsp_g)
WAVE_DRAG_TXT_TYPE = _vsp_g.WAVE_DRAG_TXT_TYPE

_vsp_g.CFD_FACET_TYPE_swigconstant(_vsp_g)
...
_vsp_g.INVALID_TYPE_swigconstant(_vsp_g)
...
_vsp_g.MESH_INDEX_AND_SLICE_TRI_swigconstant(_vsp_g)
...
_vsp_g.CFD_FACET_FILE_NAME_swigconstant(_vsp_g)
...
_vsp_g.CFD_SRF_XYZ_FLAG_swigconstant(_vsp_g)
...
_vsp_g.PROP_SURF_swigconstant(_vsp_g)
...
_vsp_g.BLEND_FREE_swigconstant(_vsp_g)
BLEND_FREE = _vsp_g.BLEND_FREE

_vsp_g.BLEND_ANGLES_swigconstant(_vsp_g)
BLEND_ANGLES = _vsp_g.BLEND_ANGLES

_vsp_g.BLEND_MATCH_IN_LE_TRAP_swigconstant(_vsp_g)
BLEND_MATCH_IN_LE_TRAP = _vsp_g.BLEND_MATCH_IN_LE_TRAP

_vsp_g.BLEND_MATCH_IN_TE_TRAP_swigconstant(_vsp_g)
BLEND_MATCH_IN_TE_TRAP = _vsp_g.BLEND_MATCH_IN_TE_TRAP

_vsp_g.BLEND_MATCH_OUT_LE_TRAP_swigconstant(_vsp_g)
BLEND_MATCH_OUT_LE_TRAP = _vsp_g.BLEND_MATCH_OUT_LE_TRAP

_vsp_g.BLEND_MATCH_OUT_TE_TRAP_swigconstant(_vsp_g)
BLEND_MATCH_OUT_TE_TRAP = _vsp_g.BLEND_MATCH_OUT_TE_TRAP

_vsp_g.BLEND_MATCH_IN_ANGLES_swigconstant(_vsp_g)
BLEND_MATCH_IN_ANGLES = _vsp_g.BLEND_MATCH_IN_ANGLES

_vsp_g.BLEND_MATCH_LE_ANGLES_swigconstant(_vsp_g)
BLEND_MATCH_LE_ANGLES = _vsp_g.BLEND_MATCH_LE_ANGLES

_vsp_g.BLEND_NUM_TYPES_swigconstant(_vsp_g)
BLEND_NUM_TYPES = _vsp_g.BLEND_NUM_TYPES

_vsp_g.COLLISION_OK_swigconstant(_vsp_g)
COLLISION_OK = _vsp_g.COLLISION_OK

_vsp_g.COLLISION_INTERSECT_NO_SOLUTION_swigconstant(_vsp_g)
COLLISION_INTERSECT_NO_SOLUTION = _vsp_g.COLLISION_INTERSECT_NO_SOLUTION

_vsp_g.COLLISION_CLEAR_NO_SOLUTION_swigconstant(_vsp_g)
COLLISION_CLEAR_NO_SOLUTION = _vsp_g.COLLISION_CLEAR_NO_SOLUTION

_vsp_g.NO_END_CAP_swigconstant(_vsp_g)
NO_END_CAP = _vsp_g.NO_END_CAP

_vsp_g.FLAT_END_CAP_swigconstant(_vsp_g)
FLAT_END_CAP = _vsp_g.FLAT_END_CAP

_vsp_g.ROUND_END_CAP_swigconstant(_vsp_g)
ROUND_END_CAP = _vsp_g.ROUND_END_CAP

_vsp_g.EDGE_END_CAP_swigconstant(_vsp_g)
EDGE_END_CAP = _vsp_g.EDGE_END_CAP

_vsp_g.SHARP_END_CAP_swigconstant(_vsp_g)
SHARP_END_CAP = _vsp_g.SHARP_END_CAP

_vsp_g.NUM_END_CAP_OPTIONS_swigconstant(_vsp_g)
NUM_END_CAP_OPTIONS = _vsp_g.NUM_END_CAP_OPTIONS

_vsp_g.SET_TARGET_swigconstant(_vsp_g)
SET_TARGET = _vsp_g.SET_TARGET

_vsp_g.GEOM_TARGET_swigconstant(_vsp_g)
GEOM_TARGET = _vsp_g.GEOM_TARGET

_vsp_g.NUM_PROJ_TGT_OPTIONS_swigconstant(_vsp_g)
NUM_PROJ_TGT_OPTIONS = _vsp_g.NUM_PROJ_TGT_OPTIONS

_vsp_g.NO_BOUNDARY_swigconstant(_vsp_g)
NO_BOUNDARY = _vsp_g.NO_BOUNDARY

_vsp_g.SET_BOUNDARY_swigconstant(_vsp_g)
SET_BOUNDARY = _vsp_g.SET_BOUNDARY

_vsp_g.GEOM_BOUNDARY_swigconstant(_vsp_g)
GEOM_BOUNDARY = _vsp_g.GEOM_BOUNDARY

_vsp_g.NUM_PROJ_BNDY_OPTIONS_swigconstant(_vsp_g)
NUM_PROJ_BNDY_OPTIONS = _vsp_g.NUM_PROJ_BNDY_OPTIONS

_vsp_g.X_PROJ_swigconstant(_vsp_g)
X_PROJ = _vsp_g.X_PROJ

_vsp_g.Y_PROJ_swigconstant(_vsp_g)
Y_PROJ = _vsp_g.Y_PROJ

_vsp_g.Z_PROJ_swigconstant(_vsp_g)
Z_PROJ = _vsp_g.Z_PROJ

_vsp_g.GEOM_PROJ_swigconstant(_vsp_g)
GEOM_PROJ = _vsp_g.GEOM_PROJ

_vsp_g.VEC_PROJ_swigconstant(_vsp_g)
VEC_PROJ = _vsp_g.VEC_PROJ

_vsp_g.NUM_PROJ_DIR_OPTIONS_swigconstant(_vsp_g)
NUM_PROJ_DIR_OPTIONS = _vsp_g.NUM_PROJ_DIR_OPTIONS

_vsp_g.LINEAR_swigconstant(_vsp_g)
LINEAR = _vsp_g.LINEAR

_vsp_g.PCHIP_swigconstant(_vsp_g)
PCHIP = _vsp_g.PCHIP

_vsp_g.CEDIT_swigconstant(_vsp_g)
CEDIT = _vsp_g.CEDIT

_vsp_g.NUM_PCURV_TYPE_swigconstant(_vsp_g)
NUM_PCURV_TYPE = _vsp_g.NUM_PCURV_TYPE

_vsp_g.PROP_CHORD_swigconstant(_vsp_g)
PROP_CHORD = _vsp_g.PROP_CHORD

_vsp_g.PROP_TWIST_swigconstant(_vsp_g)
PROP_TWIST = _vsp_g.PROP_TWIST

_vsp_g.PROP_RAKE_swigconstant(_vsp_g)
PROP_RAKE = _vsp_g.PROP_RAKE

_vsp_g.PROP_SKEW_swigconstant(_vsp_g)
PROP_SKEW = _vsp_g.PROP_SKEW

_vsp_g.NUM_PROP_PCURVE_swigconstant(_vsp_g)
NUM_PROP_PCURVE = _vsp_g.NUM_PROP_PCURVE

_vsp_g.VORTEX_LATTICE_swigconstant(_vsp_g)
VORTEX_LATTICE = _vsp_g.VORTEX_LATTICE

_vsp_g.PANEL_swigconstant(_vsp_g)
PANEL = _vsp_g.PANEL

_vsp_g.MANUAL_REF_swigconstant(_vsp_g)
MANUAL_REF = _vsp_g.MANUAL_REF

_vsp_g.COMPONENT_REF_swigconstant(_vsp_g)
COMPONENT_REF = _vsp_g.COMPONENT_REF

_vsp_g.NUM_REF_TYPES_swigconstant(_vsp_g)
...
def SetSubSurfName(geom_id, sub_id, name):
    return _vsp_g.SetSubSurfName(geom_id, sub_id, name)
SetSubSurfName = _vsp_g.SetSubSurfName

def GetSubSurfName(geom_id, sub_id):
    return _vsp_g.GetSubSurfName(geom_id, sub_id)
