...
os.chdir("/home/simonx/Documents/Udacity/ML/Projects/capstone/OpenVSP2")
...
SetParmVal( WingBody, "Area", "XSec_1", 45.0 );
SetParmVal( WingBody, "Sweep", "XSec_1", 40.0 );
...
#ChangeXSecShape( Pod, 0, XS_SUPER_ELLIPSE )
